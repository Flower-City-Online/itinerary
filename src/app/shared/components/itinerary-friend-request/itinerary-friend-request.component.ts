...
@Component({
  selector: 'app-itinerary-friend-request',
  templateUrl: './itinerary-friend-request.component.html',
  styleUrl: './itinerary-friend-request.component.scss',
})
export class ItineraryFriendRequestComponent implements OnInit {
